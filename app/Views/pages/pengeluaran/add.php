...
<div class="container-fluid">
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form method="POST" action="<?= base_url(); ?>Pengeluaran/process_add">
                <div class="row">
                    <div class="col-sm-4">
                    ...
                    <div class="col-sm-4">
                        <label>Total:</label>
                        <input class="form-control form-control-sm" type="number" placeholder="Harga" aria-label=".form-control-sm example" name='jumlah' required>
                    </div>
                    <div class="col-sm-4">
